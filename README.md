...
- **Back-end & Veritabanı:** PostgreSQL ve Prisma ORM (Geliştirme Aşamasında)
- **Deployment:** Vercel

## 👥 Ekip
Bu proje, YBS disiplinine uygun olarak uçtan uca bir SaaS mimarisiyle geliştirilmektedir:
- **İsmail, Yağız, Enes, Osman**

*Bu proje, Yönetim Bilişim Sistemleri vizyonuyla, sahada yaşanan gerçek operasyonel problemlere ölçeklenebilir çözümler üretmek amacıyla geliştirilmektedir.*